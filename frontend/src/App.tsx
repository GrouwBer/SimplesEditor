...
function defineSimplesTheme(monaco: Parameters<BeforeMount>[0]) {
...
function App() {
  ...
  const handleBeforeMount: BeforeMount = (monaco) => {
    ...
    // Define o tema escuro customizado
  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        {/* Code Editor Panel — SIMPLES language */}
        <section style={{
          flex: 1,
          display: 'flex',
          flexDirection: 'column',
